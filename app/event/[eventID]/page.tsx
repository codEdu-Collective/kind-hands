          ...
          <div className="w-full max-w-7xl my-8 sm:my-12 md:my-16 lg:my-24 xl:my-30 flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 w-full max-w-7xl min-h-auto text-white relative -top-8 sm:-top-12 md:-top-16 gap-4 sm:gap-0 mb-8 sm:mb-12">
              <div className="bg-primary dark:bg-primary px-4 sm:px-5 md:px-6 py-6 sm:py-7 md:py-9 rounded-lg sm:rounded-none">
                <h3 className="font-shippori font-extrabold text-lg sm:text-xl md:text-2xl mb-2 sm:mb-3 md:mb-4">
                  Start
                </h3>
              ...
              <div className="bg-accent dark:bg-accent-400 text-dark dark:text-dark px-4 sm:px-5 md:px-6 py-6 sm:py-7 md:py-9 rounded-lg sm:rounded-none">
                <h3 className="font-shippori font-extrabold text-lg sm:text-xl md:text-2xl mb-2 sm:mb-3 md:mb-4 dark:text-dark">
                  Venue
                </h3>
                <p className="font-work font-medium text-sm sm:text-base md:text-lg dark:text-dark">
                  {event.venue},
                </p>
                <p className="font-work font-medium text-sm sm:text-base md:text-lg dark:text-dark">
                  {event.venueAddress}
            ...
            <article className="w-full max-w-7xl text-justify px-4 sm:px-6">
              <div>
                <h1 className="font-shippori font-extrabold text-2xl sm:text-3xl md:text-4xl mb-3 dark:text-white">
                  Event Description
                </h1>
                <p className="font-work text-sm sm:text-base md:text-lg lg:text-xl text-neutral dark:text-gray-300">
                  {event.description}
                </p>
                <h2 className="font-shippori font-extrabold text-xl sm:text-2xl mt-6 sm:mt-8 md:mt-10 mb-3 sm:mb-4 dark:text-white">
                  Event Content
                </h2>
                <p className="font-work text-sm sm:text-base md:text-lg lg:text-xl text-neutral dark:text-gray-300">
                  {event.content}
