  ...
  return (
    <main className="w-full">
      <header className="relative h-96 md:h-205.5 flex items-center">
        <Image src="/licences/licence-banner.png" alt="hero" fill className="object-cover" />
      ...
      <div className="mx-auto w-full max-w-300 h-auto md:h-[600px] px-4 md:px-8 lg:px-0 my-8 md:my-37.5 flex flex-col gap-6 md:gap-12">
        ...
        <div className="flex flex-col gap-6 md:gap-12 ">
          ...
          <div>
            ...
            <h2 className="font-shippori font-extrabold text-2xl my-3">Unsplash: Licenced</h2>
            ...
            <h2 className="font-shippori font-extrabold text-2xl my-5">Pexels: Licenced</h2>
            <p className="font-work text-neutral text-xl">
              Image 1, Image 2, Image 3, Image 4, Image 5, Image 6, Image 7, Image 8, Image 9, Image
              10, Image 11, Image 12, Image 13, Image 14, Image 15, Image 16, Image 17, Image 18,
              Image 19
