  ...
  return (
    <section className="w-full min-h-auto flex justify-center items-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-20">
      <div className="w-full max-w-7xl text-center">
        <h3 className="font-sue-ellen text-2xl sm:text-3xl md:text-4xl text-primary mb-2 sm:mb-4">
          What we do
        </h3>
        <h2 className="font-shippori font-extrabold text-xl sm:text-2xl md:text-3xl lg:text-[2.5rem] mb-6 sm:mb-8 md:mb-10">
