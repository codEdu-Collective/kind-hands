...
const Team = () => {
  return (
    <section className="w-full min-h-217.5 bg-beige flex flex-col justify-center items-center py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
      <h2 className="font-sue-ellen text-2xl sm:text-3xl md:text-4xl text-primary mb-2">Team</h2>
      ...
      <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-6 mt-6 sm:mt-8 md:mt-10 text-dark dark:text-white w-full max-w-300">
        {["Martin Luther", "Keira Knightley", "Jack Sparrow"].map((member, index) => (
          <div key={index} className="text-center w-full sm:w-[calc(50%-0.75rem)] lg:w-auto">
            <div className="relative w-full sm:w-auto mx-auto max-w-[283px] h-96 sm:h-auto">
              <Image
            ...
            <h4 className="my-3 sm:my-4 md:my-4.5 font-shippori font-extrabold text-lg sm:text-xl dark:text-white">
              {member}
            </h4>
        ...
        <div className="bg-accent w-full sm:w-[calc(50%-0.75rem)] lg:w-70.5 min-h-[300px] sm:min-h-0 sm:h-full flex flex-col justify-center items-center text-center px-4 sm:px-4.5 py-8 sm:py-0">
          ...
          />
          <h4 className="font-shippori font-extrabold text-xl sm:text-2xl">Become a Volunteer</h4>
          <p className="font-work text-base sm:text-lg md:text-xl my-3 sm:my-4">
