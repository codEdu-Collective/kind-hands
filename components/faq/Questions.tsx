  ...
  return (
    <>
      {questions.map((question, index) => (
        <div key={index} className="group border-b border-neutral dark:border-gray-600 py-4 sm:py-5 cursor-pointer">
          <div className="flex justify-between items-start gap-3 sm:gap-4 mr-0 sm:mr-3">
            <h2 className="font-shippori font-extrabold text-lg sm:text-xl md:text-2xl text-dark dark:text-white flex-1">{question}</h2>
