            ...
            <div className="flex space-x-8">
              ...
              >
                ...
                <div className="absolute top-full left-0 hidden group-hover:block w-48 pt-4">
                  <div className="bg-white dark:bg-dark shadow-xl rounded-md py-2 border border-gray-200 dark:border-gray-800 dark:text-dark-700">
                    <Link
                      href="/causes"
                      className="block px-4 py-2 hover:bg-gray-200 dark:hover:bg-dark-800 text-dark dark:text-white transition-colors"
                    >
                      Causes
                    </Link>
                    <Link
