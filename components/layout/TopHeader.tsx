...
export default function TopHeader(): JSX.Element {
  return (
    <div
      ...
      style={{ backgroundColor: "var(--color-accent)" }} //#77d7d3
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex justify-between items-center">
          ...
          <div className="relative">
            <div
              className="flex space-x-3 items-center ml-4 border-l border-gray-300 pl-4 absolute right-0 top-1/2 transform -translate-y-1/2 h-full"
              style={{ backgroundColor: "var(--color-accent-700)" }} //#5faba7
            >
              ...
              <a href="https://pinterest.com" className="text-white hover:text-gray-200 transition">
                {/* Pinterest Icon */}
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
