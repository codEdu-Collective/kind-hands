...
export default function TopHeader() {
  return (
    <div className="bg-accent text-deep-teal text-sm relative z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 md:py-3">
        <div className="flex flex-col md:flex-row justify-between items-center gap-2 md:gap-0">
          ...
          <div className="flex items-center">
            <div className="flex space-x-4 items-center md:pl-6 md:border-l md:border-deep-teal/20">
              <a
                href="https://instagram.com"
                className="text-deep-teal hover:text-primary transition-colors transform hover:scale-110"
